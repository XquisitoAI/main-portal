...
const Header: React.FC = () => {
  ...
  const filteredBranches = selectedClient
    ? branches.filter((branch) => branch.clientId === selectedClient)
    : branches;
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center">
            ...
            <select
              id="client-selector"
              className="bg-white border border-gray-300 text-gray-700 py-2 px-3 pr-8 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div className="relative inline-block">
            <div className="flex items-center bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-700">
              ...
              <span className="mr-2">
                {currentBranch?.name ||
                  (currentClient ? "Todas las sucursales" : "Todas")}
              </span>
            ...
            <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 z-10 hidden">
              <div className="p-2">
                <select
                  className="w-full bg-white border border-gray-300 text-gray-700 py-2 px-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
